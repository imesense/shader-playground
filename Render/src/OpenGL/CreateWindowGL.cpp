...
namespace WindowOpenGL
{
	bool WindowOpenGL::GLWindowCreate(const char* title, int width, int height)
	{
		...
		wcx.lpfnWndProc = reinterpret_cast<WNDPROC>(StaticWndProc);
		wcx.hInstance = g_hInstance;
		wcx.lpszClassName = L"GLWINDOW_CLASS_NAME";
		...
		// создаем окно
		g_hWnd = CreateWindowExA(exStyle, "GLWINDOW_CLASS_NAME", title, style, rect.left, rect.top,
